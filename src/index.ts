...
function makethen<A, R>(fn: (arg: A, cb: NodeCallback1<R>) => void): (arg: A) => Promise<R | void>
...
function makethen<A1, A2, R>(fn: (arg1: A1, arg2: A2, cb: NodeCallback1<R>) => void): (arg1: A1, arg2: A2) => Promise<R | void>
...
function makethen<A1, A2, A3, R>(fn: (arg1: A1, arg2: A2, arg3: A3, cb: NodeCallback1<R>) => void): (arg1: A1, arg2: A2, arg3: A3) => Promise<R | void>
